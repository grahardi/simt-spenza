<style>
    ...
    .kop-teks { text-align: center; font-weight: bold; font-size: 9pt; line-height: 1.3; border-bottom: 1.5px solid #000; padding-bottom: 4px; margin-bottom: 5px; }
    ...
    .ttd p { margin: 1px 0; }
    .ttd-nama { margin-top: 8px; font-weight: bold; text-decoration: underline; }
