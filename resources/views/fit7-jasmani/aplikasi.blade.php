...
<div style="max-width:1200px;margin:0 auto;padding:16px 22px;">
  <a href="{{ route('fit7-jasmani.index') }}" style="display:inline-flex;align-items:center;gap:8px;padding:9px 13px;border-radius:10px;background:#fff;border:1px solid #e2e8f0;color:#334155;text-decoration:none;font-weight:800;font-size:13px;">
