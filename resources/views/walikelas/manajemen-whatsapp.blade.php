...
<div class="px-4 py-2 mb-3 text-white rounded shadow" style="background:#4b0082;">
    <h1 class="h5 pt-2 mb-0"><i class="fab fa-whatsapp me-2"></i>Manajemen WhatsApp - Kelas {{ $kelas }}</h1>
</div>

<div class="bg-white rounded shadow overflow-hidden">
    @if ($siswa->isEmpty())
        <div class="text-muted text-center py-4">
            <i class="far fa-question-circle me-1"></i> Belum ada siswa di kelas ini.
        </div>
    @else
        <div class="table-responsive">
        <table class="table table-striped mb-0 align-middle">
            <thead>
                <tr><th>No. Induk</th><th>Nama Siswa</th><th>Nomor WhatsApp Terdaftar</th></tr>
            </thead>
            <tbody>
                @foreach ($siswa as $s)
