...
<div class="p-4 bg-white rounded shadow" style="max-width:480px;">
    <p class="text-muted small">Pilih guru yang mau diajukan absennya (Sakit/Ijin/Dispensasi). Ajuan akan masuk antrian "Menunggu ACC" dulu.</p>
    <form method="GET" onsubmit="event.preventDefault(); window.location = '{{ url('/absen-guru/ajuan') }}/' + document.getElementById('pilihGuru').value;">
        <div class="mb-3">
        ...
        <a href="{{ route('absen-guru.index') }}" class="btn btn-outline-secondary">Batal</a>
    </form>
</div>
@endsection
