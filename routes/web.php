...
Route::middleware(['auth:member', \App\Http\Middleware\ForcePasswordChange::class])->group(function () {
    ...
    // Agenda - kalender kegiatan sekolah, semua orang bisa lihat, tambah/edit/hapus khusus kesiswaan/admin_kegiatan
    ...
    Route::get('/agenda/list', [\App\Http\Controllers\AgendaController::class, 'listSudah'])->name('agenda.list-sudah');
    Route::get('/agenda/mendatang', [\App\Http\Controllers\AgendaController::class, 'mendatang'])->name('agenda.mendatang');
    Route::get('/agenda/{agenda}/galeri', [\App\Http\Controllers\AgendaController::class, 'galeri'])->name('agenda.galeri');
    Route::middleware('role:kesiswaan,admin_kegiatan')->group(function () {
    ...
    Route::prefix('superadmin')->name('superadmin.')->middleware('role:superadmin')->group(function () {
        ...
        Route::get('/whatsapp-template', [\App\Http\Controllers\Superadmin\WhatsappTemplateController::class, 'index'])->name('whatsapp-template.index');
        Route::get('/whatsapp-template/{whatsappTemplate}/edit', [\App\Http\Controllers\Superadmin\WhatsappTemplateController::class, 'edit'])->name('whatsapp-template.edit');
        ...
        Route::get('/whatsapp-guru', [\App\Http\Controllers\Superadmin\WhatsappGuruController::class, 'index'])->name('whatsapp-guru.index');
        Route::get('/whatsapp-guru/export-vcf', [\App\Http\Controllers\Superadmin\WhatsappGuruController::class, 'exportVcf'])->name('whatsapp-guru.export-vcf');
        Route::delete('/whatsapp-guru/{guruWhatsapp}', [\App\Http\Controllers\Superadmin\WhatsappGuruController::class, 'putuskan'])->name('whatsapp-guru.putuskan');
    });
    ...
    Route::get('/bansos/export', [\App\Http\Controllers\BansosController::class, 'exportExcel'])
        ->name('bansos.export')->middleware('role:tatib,kesiswaan');
    ...
    Route::get('/aktivitas-kelas/pelanggaran-siswa', [AktivitasKelasController::class, 'pelanggaranSiswa'])
